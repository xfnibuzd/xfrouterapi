    ...
    () => [
      {
        ...
        color: 'docs-card docs-card-accent-blue',
        items: [
          {
            title: t('当前余额'),
      ...
      },
      {
        ...
        color: 'docs-card docs-card-accent-green',
        items: [
          {
            title: t('请求次数'),
      ...
      },
      {
        ...
        color: 'docs-card docs-card-accent-yellow',
        items: [
          {
            title: t('统计额度'),
      ...
      },
      {
        ...
        color: 'docs-card docs-card-accent-indigo',
        items: [
          {
            title: t('平均RPM'),
