...
const AccountManagement = ({
  ...
  const renderAccountInfo = (accountId, label) => {
    if (!accountId || accountId === '') {
      return <span className='text-[var(--docs-muted)]'>{t('未绑定')}</span>;
    }
    ...
    const popContent = (
      <div className='text-xs p-2'>
        ...
        {label ? (
          <div className='mt-1 text-[11px] text-[var(--docs-muted)]'>{label}</div>
        ) : null}
      </div>
    );
    ...
    return (
      <Popover content={popContent} position='top' trigger='hover'>
        <span className='block max-w-full truncate text-[var(--docs-muted)] hover:text-[var(--docs-primary)] cursor-pointer'>
          {accountId}
        </span>
      </Popover>
    );
          ...
          <div className='py-4'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              ...
              <Card className='docs-card border border-[var(--docs-border)] !bg-[var(--docs-surface-strong)]'>
                <div className='flex items-center justify-between gap-3'>
                  <div className='flex items-center flex-1 min-w-0'>
                    <div className='w-10 h-10 rounded-full bg-[var(--docs-surface)] border border-[var(--docs-border)] flex items-center justify-center mr-3 flex-shrink-0'>
                      <IconMail
                        size='default'
                    ...
                    <div className='flex-1 min-w-0'>
                      <div className='font-medium text-[var(--docs-text)]'>
                        {t('邮箱')}
                      </div>
                      <div className='text-sm text-[var(--docs-muted)] truncate'>
                        {renderAccountInfo(
              ...
              <Modal
                ...
                footer={null}
              >
                <div className='my-3 text-sm text-[var(--docs-muted)]'>
              ...
              {status.custom_oauth_providers &&
                status.custom_oauth_providers.map((provider) => {
                  ...
                  return (
                    <Card key={provider.slug} className='docs-card border border-[var(--docs-border)] !bg-[var(--docs-surface-strong)]'>
                      <div className='flex items-center justify-between gap-3'>
                        <div className='flex items-center flex-1 min-w-0'>
                          <div className='w-10 h-10 rounded-full bg-[var(--docs-surface)] border border-[var(--docs-border)] flex items-center justify-center mr-3 flex-shrink-0'>
                            {getOAuthProviderIcon(
              ...
              <Space vertical className='w-full'>
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-[var(--docs-surface)] border border-[var(--docs-border)] flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconKey size='large' className='text-[var(--docs-text)]' />
                      </div>
                    ...
                    <Button
                      ...
                      className='!bg-[var(--docs-primary)] hover:opacity-80 w-full sm:w-auto'
                      icon={<IconKey />}
                    >
                ...
                <Card className='docs-card border border-[var(--docs-border)] !bg-[var(--docs-surface-strong)] w-full'>
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-[var(--docs-surface)] border border-[var(--docs-border)] flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconLock size='large' className='text-[var(--docs-text)]' />
                      </div>
                      <div>
                        <Typography.Title heading={6} className='mb-1 text-[var(--docs-text)]'>
                          {t('密码管理')}
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 text-xs text-[var(--docs-muted)] space-y-1'>
                          <div>
                    ...
                    <Button
                      ...
                      className={`w-full sm:w-auto ${passkeyEnabled ? '!bg-[var(--docs-danger,#ef4444)] hover:opacity-80' : ''}`}
                      icon={<IconKey />}
                ...
                <Card className='docs-card border border-[var(--docs-border)] !bg-[var(--docs-surface-strong)] w-full'>
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-[var(--docs-surface)] border border-[var(--docs-border)] flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconDelete size='large' className='text-[var(--docs-text)]' />
                      </div>
                      <div>
                        <Typography.Title
                          heading={6}
                          className='mb-1 text-[var(--docs-text)]'
                        >
                          {t('删除账户')}
                        </Typography.Title>
                        <Typography.Text className='text-sm text-[var(--docs-muted)]'>
                    ...
                    <Button
                      ...
                      className='w-full sm:w-auto !bg-[var(--docs-danger,#ef4444)] hover:opacity-80'
                      icon={<IconDelete />}
                    >
                      {t('删除账户')}
                    </Button>
