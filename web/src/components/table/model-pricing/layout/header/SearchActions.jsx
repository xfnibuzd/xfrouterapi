    ...
    return (
      <div className='flex items-center gap-2 w-full'>
        ...
        <Button
          ...
          className='!bg-[var(--docs-primary)] hover:opacity-80 !text-white disabled:opacity-50'
        >
          {t('复制')}
        </Button>
          ...
          <>
            ...
            {supportsCurrencyDisplay && (
              <div className='flex items-center gap-2'>
                <span className='text-sm text-[var(--docs-muted)]'>{t('充值价格显示')}</span>
                <Switch
            ...
            {/* 显示倍率开关 */}
            <div className='flex items-center gap-2'>
              <span className='text-sm text-[var(--docs-muted)]'>{t('倍率')}</span>
